 ...
 * 
 * @author https://stackoverflow.com/users/7808753/django
 */
public class JarUtils {
    private static final String JAR_EXTENSION = ".jar";
 
    public static FileHandle[] listFromJarIfNecessary(String folderPath, boolean acceptFolders) {
        return listFromJarIfNecessary(new JarFileFilter(folderPath, acceptFolders));
    }
    ...
    private static boolean shouldLoadFromJar() {
        return (Gdx.app.getType() == Application.ApplicationType.Desktop || Gdx.app.getType() == Application.ApplicationType.HeadlessDesktop)
                && getJarFile() != null;
    }
