...
public class MerchantDevil extends Merchant {
	private static final IntRange OFFERS_RANGE = IntRange.of(2, 5);
	
	public MerchantDevil() {
		super("Devil", "devil", 1.0F, 2.0F);
	}

	@Override
	public void refreshOffers() {
		this.offers.size = 0;
		this.offers.add(new MerchantOfferSale(GameRegistry.toolCrapbomb, 1));
	...
	private ItemTradeable getRandomItemFromPool() {
		...
		while (item == null) {
			final ItemTradeable randomItem = GameRegistry.MERCHANT_DEVIL_TRADE_POOL.random();
